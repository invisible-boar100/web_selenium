                    ...
                    <div class="content">
                        <div class="left">
                            ...
                            <div class="ad_nav">
                                ...
                                <a href="./customers.php" class="nav_item active">
                                    <div class="nav_icon">
                                ...
                                <div class="pg_content sm">
                                    ...
                                    <div class="or_table">
                                        ...
                                        <table class="table" id="cu_data">
                                            ...
                                            <tbody>
                                                <?php
                                                foreach ($ordersCustomerAdmin as $order) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="actions">
                                                            <a href="<?php echo "../Actions/deleteFunction.php?deletecusID=" . $order['order_id']; ?>"><img src="../Assets/icons/fluent_delete-20-filled-black.svg" alt=""></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
