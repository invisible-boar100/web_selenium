                    ...
                    <div class="content">
                        <div class="left">
                            ...
                            <div class="ad_nav">
                                ...
                                <a href="./orders.php" class="nav_item active">
                                    <div class="nav_icon">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="actions">
                                                            <a href="<?php echo "../Actions/deleteFunction.php?deleteOrdID=" . $order['order_id']; ?>"><img src="../Assets/icons/fluent_delete-20-filled-black.svg" alt=""></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
