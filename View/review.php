...
$orderReviews = select_orderDetails_admin_controller();
                    ...
                    <div class="content">
                        ...
                        <div class="left">
                            ...
                            <div class="p_account_menu">
                                ...
                                <a href="./review.php" class="ac_menu_plq active">
                                    <div class="icon">
                                        <img src="../Assets/icons/ic_outline-rate-review-white.svg" alt="">
                                    </div>
                                    <p>Reviews</p>
                                </a>
                        ...
                        <div class="right">
                            <div class="content">
                                <div class="heading">
                                    <h2 class="">Pending Reviews</h2>
                                </div>

                                <!-- reviews table -->
                                <div class="or_table">

                                    <table class="table" id="cu_data">
                                        <thead>
                                            <tr>
                                                <th>Product Name</th>
                                                <th>Actions</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="actions">
                                                        <a href="<?php echo "./writeReview.php?product_id=" . $review['product_id']; ?>">Write a review</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
