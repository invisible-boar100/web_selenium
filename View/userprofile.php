                    ...
                    <div class="content">
                        ...
                        <div class="left">
                            ...
                            <div class="p_account_menu">
                                <a href="./userprofile.php" class="ac_menu_plq active">
                                    <div class="icon">
                                        <img src="../Assets/icons/fa-regular_user-white.svg" alt="">
                                    </div>
                                    ...
                                    <form action="../Actions/updateUser.php" method = "POST">
                                        <div class="sbs">
                                            <div class="form_control">
                                                ...
                                                <input type="text" name = "fname" value ="<?php echo $customers['user_fname'] ?>">
                                            </div>
                                            <div class="form_control">
                                                <label for="">Last Name</label>
                                                <input type="text" name = "lname" value ="<?php echo $customers['user_lname'] ?>">
                                            </div>
                                        </div>
                                        <div class="form_control">
                                            <label for="">Email</label>
                                            <input type="text" name = "email" value ="<?php echo $customers['user_email'] ?>">
                                        </div>
                                        <div class="form_control">
                                            <label for="">Phone Number</label>
                                            <input type="text" name = "contact" value ="<?php echo $customers['user_contact'] ?>">
                                        </div>
                                        
                                       
                                        <div class="form_control">
                                            <input type="hidden" name="user_id" id="" value="<?php echo $customers['user_id'] ?>">
                                        </div>
                                        <div class="sbs btn">
