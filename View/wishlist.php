                    ...
                    <div class="content">
                        ...
                        <div class="left">
                            ...
                            <div class="p_account_menu">
                                ...
                                <a href="./orders.php" class="ac_menu_plq">
                                    <div class="icon">
                                        <img src="../Assets/icons/octicon_package-dependencies-24-black.svg" alt="">
                                    </div>
                                    <p>My Orders</p>
                                </a>
                                <a href="./wishlist.php" class="ac_menu_plq active">
                                    <div class="icon">
                                        <img src="../Assets/icons/akar-icons_heart-white.svg" alt="">
                                    </div>
                                    <p>Wishlist</p>
                                </a>
                                    ...
                                    ?>
                                        <div class="order_item">
                                            <div class="item_det">
                                                <div class="dets">
                                                    <div class="icon">
                                                        <img src="<?php echo $wishlist['product_image'] ?>" alt="">
                                                    </div>
                                                    <div class="text">
                                                        <h3><?php echo $wishlist['product_title'] ?></h3>
                                                        <p class="item_price">&#8373;<?php echo $wishlist['product_price'] ?></p>
                                                    </div>
                                                </div>
                                                <!-- actions -->

                                                <button><a href="../Actions/addCart.php?cartID=<?php echo $wishlist['product_id'] ?> &qty=1">Add to Cart</a></button>
                                                <a href="../Actions/remove_from_wishlist.php?p_id=<?php echo $wishlist['product_id'] ?>"><img src="../Assets/icons/fluent_delete-20-filled-black.svg" alt=""></a>
                                            </div>
                                        </div>
                                    <?php
                                    }
...
<?php
    ...
    echo "<script>alert('Create an account to access wishlist'); window.history.back();</script>";
}
?>